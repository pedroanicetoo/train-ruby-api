...
RAILS_VERSION="5.2"
MYSQL_PASSWORD="toor"
GIT_USER_NAME="Pedro Aniceto"
GIT_USER_EMAIL="pedro_madri@hotmail.com"
NODE_VERSION="6"
...
sudo apt-get install -y git-core curl zlib1g-dev build-essential libssl-dev libreadline-dev libyaml-dev \
                        libsqlite3-dev sqlite3 libxml2-dev libcurl4-openssl-dev software-properties-common \
...
# FORMA ANTIGA DE INSTALAR O OH-MY-ZSH
#sudo apt-get update
